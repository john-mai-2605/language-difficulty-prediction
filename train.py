...
# BT = Regressor(xgb.train(param, dtrain, 100, 
...
NN = Regressor(neural_network.MLPRegressor(hidden_layer_sizes = (100, 10), random_state=1, max_iter=100, alpha = 0.001))
...
# MLP
print("Multi Perceptron Layer (NN)")
NN = Classifier(neural_network.MLPClassifier(hidden_layer_sizes = (100, 10), random_state=1, max_iter=300, alpha = 0.001))
